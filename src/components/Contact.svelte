<div class="max-w-7xl px-4 lg:px-6 lg:px-8 py-12 lg:py-24 mx-auto">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 lg:items-center gap-6 md:gap-8 lg:gap-12">
      <div class="aspect-w-16 aspect-h-6 lg:aspect-h-14 overflow-hidden bg-gray-800 rounded-2xl dark:bg-neutral-800">
        <img class="group-hover:scale-105 transition-transform duration-500 ease-in-out object-cover rounded-2xl" src="https://criticascience.org/wp-content/uploads/2023/01/22276CRT-Website-Heros_About-copy-2-scaled.webp" alt="Image Description">
      </div>
      <!-- End Col -->
          ...
          <div class="grid sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8 lg:gap-12">
            <div class="flex gap-4">
              ...
              <div class="grow">
                ...
                <p>
                  <a class="relative inline-block font-medium text-black before:absolute before:bottom-0.5 before:start-0 before:-z-[1] before:w-full before:h-1 before:bg-lime-400 hover:before:bg-black focus:outline-none focus:before:bg-black dark:text-black dark:hover:before:bg-black dark:focus:before:bg-black" href="mailto:example@site.so">
                    contact@primecaptures.com
                  </a>
                </p>
              </div>
            </div>
